...
<!--	<div class="row">
		...
		<?php //echo $form->dropDownList($model,'parent_id',CHtml::listData(Storecategories::model()->findAll(),'category_id','category_name'),array('prompt'=> 'Please Select')); ?>
...
<!--	<div class="row">
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('class'=>'btn btn-success btn-large')); ?>
		 ...
		 <input type="button" onclick="window.location.href ='<?php echo Yii::app()->request->baseUrl.'/index.php/storecategories/admin'; ?>'"  class="btn btn-large" value="Cancel" >
	</div>
