...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'pooja_category_id'); ?>
		<?php echo $form->dropDownList($model,'pooja_category_id',CHtml::listData(Poojacategories::model()->findAll(),'category_id','category_name'),array('prompt'=> 'Please Select')); ?>
	</div>
