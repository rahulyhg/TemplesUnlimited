...
?>
  ...
  <li>
	  ...
	  <span class="blue"><?php echo CHtml::encode($data->getAttributeLabel('pooja_id')); ?> : <strong><?php echo CHtml::link(CHtml::encode($data->id), array('view', 'id'=>$data->id)); ?></strong></span><br />
	  <span class="blue"><?php echo CHtml::encode($data->getAttributeLabel('pooja_name')); ?> : <strong><?php echo CHtml::encode($data->temple_name); ?></strong></span><br />
