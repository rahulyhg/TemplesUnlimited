...
class CKkceditor extends CInputWidget
{
  ...
  public function run()
  {
    ...
    if ($this->filespath&&$this->filesurl) {		  
      $oCKeditor->config['filebrowserBrowseUrl']  = Yii::app()->baseUrl.'/uploads/news/';
      $oCKeditor->config['filebrowserImageBrowseUrl']  = Yii::app()->request->baseUrl.'/uploads/news/';
      $oCKeditor->config['filebrowserFlashBrowseUrl']  = Yii::app()->request->baseUrl.'/uploads/news/';
      $oCKeditor->config['filebrowserUploadUrl']  = Yii::app()->request->baseUrl.'/uploads/';
      $oCKeditor->config['filebrowserImageUploadUrl']  = Yii::app()->request->baseUrl.'/uploads/';
      $oCKeditor->config['filebrowserFlashUploadUrl']  = Yii::app()->request->baseUrl.'/uploads/news/';
	  $session=new CHttpSession;
	  $session->open();
      $session['KCFINDER'] = array(
		'disabled'=>true,
		'uploadURL'=>Yii::app()->request->baseUrl.'/uploads/news/',
		'uploadDir'=>Yii::app()->request->baseUrl.'/uploads/',
		'theme' => "default",
		);
    }
