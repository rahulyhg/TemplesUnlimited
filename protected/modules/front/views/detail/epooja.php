...
<div class="best-places-wrap">
          <ul class="items items-grid-view clearfix onecolumn">
			...
			$relateds = Pooja::model()->getrelatedproducts($model->pooja_id);
              ...
              <div class="item-thumbnail" > <a href="<?php echo CHtml::normalizeUrl(array("detail/pooja/id/".helpers::simple_encrypt($related->pooja_id))); ?>"><img alt="Item thumbnail" src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $poojaimage; ?>"   class="thumbnailimg" style="width:100%;"></a> </div>
