...
<?php 
if(($detailsmodel->iyer_experience_type=='') && ($detailsmodel->iyer_amount_option=='')  && ($detailsmodel->iyer_amount=='0.00') && ($detailsmodel->iyer_wh=='0.00') && ($detailsmodel->iyer_overview=='') && ($detailsmodel->iyer_experience=='0.0')) {?>
