...
<div class="pagination">
    ...
    <li><a href="#">&raquo;</a></li>
	  ...
	  <div id="ait-dir-register-tab" style="display:none; height:auto;">
	...
	<a href="<?php echo CHtml::normalizeUrl(array("detail/guide/id/".helpers::simple_encrypt(150))); ?>" class="sc-button aligncenter left store-cart" style="background-color: #CB202D; border-radius:10px; margin-left:32px;"><span class="border"><span class="wrap"><span class="title" style="color: #ffffff;">View Details</span></span></span></a>&nbsp;&nbsp;</div>
