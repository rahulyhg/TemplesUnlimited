 ...
 <?php } ?>
  ...
  <footer id="colophon" class="page-footer mainpage" role="contentinfo">
	 ...
	 <div class="row" ><div class="col-md-12" id="req-email" style=" float:left;color:#FF0000;font-size:12px; margin-top:-1px; font-size:12px;"></div></div>
		...
		<div id="footer-text">
		<span><strong>© Copyright 2016 Temples Unlimited Inc.</strong>All rights reserved.</span><!--Developed by  <a target="_blank" href="http://blaze.ws/"  style="color:#666666;"><strong>BLAZE WEB SERVICES.</strong></a>-->
		</div>
