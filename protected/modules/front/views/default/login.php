...
$this->pageTitle=Yii::app()->name . ' - Login and Registration';
...
.zocial.linkedin {
    ...
    background-image: url("<?php echo Yii::app()->request->baseUrl; ?>/image/linkedin.png");
...
.zocial.google {
    background-color: rgba(0, 0, 0, 0);
    background-image: url("<?php echo Yii::app()->request->baseUrl; ?>/image/google.png");
    background-repeat: no-repeat;
    border: medium none;
    height: 50px !important;
    width: 37px;
...
.zocial.facebook {
    background-color: rgba(0, 0, 0, 0);
    background-image: url("<?php echo Yii::app()->request->baseUrl; ?>/image/fb.png");
    background-repeat: no-repeat;
    border: medium none;
    height: 50px !important;
    width: 37px;
...
.zocial.twitter {
    background-color: rgba(0, 0, 0, 0);
    background-image: url("<?php echo Yii::app()->request->baseUrl; ?>/image/twitter.png");
    background-repeat: no-repeat;
    border: medium none;
    height: 50px !important;
    width: 37px;
...
<?php if(isset($_REQUEST['pooja'])){ ?>
 <div class="flashmessage success" id="flashmessage" >
	<p><?php echo  "Please login to Book this pooja."; ?></p>
</div>
<?php } ?>

<?php if(isset($_REQUEST['review'])){ ?>
 <div class="flashmessage success" id="flashmessage" >
	<p><?php echo  "Please login to Post your Reviews."; ?></p>
</div>
<?php } ?>

<?php if(isset($_REQUEST['fav'])){ ?>
 <div class="flashmessage success" id="flashmessage" >
	<p><?php echo  "Please login to Add your favorite."; ?></p>
</div>
<?php } ?>



<?php if( Yii::app()->user->hasFlash('email_verified')){ 
?>
 <div class="flashmessage success" id="flashmessage" >
	<button class="close" data-dismiss="alert" onclick="document.getElementById('flashmessage').style['display'] ='none';">X</button>
	<p><table>
		<tr>
		Welcome <?php echo  Yii::app()->user->getFlash('email_verified'); ?>,
		</tr>
		<br />
		<tr>
		Thank you for verifying your email address. You can now login and activate your account.
		</tr>
		</table>
		</p>
</div>
...
<h3 class="section-title" style="margin:0px 0px 20px 0px;">User Login</h3>	
	...
	<div class="not-logged">
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
					...
					'action'=>CController::CreateUrl('/login'),
			...
			<!--<a href="" class="right"><strong>Forgot Password</strong></a>-->
			 <?php echo  CHtml::link('Forgot Password', CController::CreateUrl('/forgot'),array( 'class'=>'right')); ?>
			<br>
<br>
			<p class="login-submit" style="margin-top:-11px;">
    ...
    array('//front/default/login'),
         ...
         // alert(data);
                                         ...
                                         parent.location.href = SITE_BASE_URL+"user";
                                      }
          else{
...
<div>
<div id="user_form">
<h3 class="section-title" style="margin:0px 0px 20px 0px;">New User Registration</h3>	
		...
		<div id="ait-login-tabs">
				...
				<?php $form=$this->beginWidget('CActiveForm', array(
					...
					<div class="register-gender">
						...
						<?php echo $form->dropDownList($normalregister,'gender',array('Mr'=>'Mr.','Ms'=>'Ms.','Mrs'=>'Mrs.'),array('prompt'=> 'Please Select','style'=>"box-sizing: border-box;
width: 100%;
margin-bottom: 15px;
padding: 3%;
...
border-image-repeat: initial;")); ?>
					...
					<div class="register-language">
							...
							<?php echo $form->dropDownList($normalregister,'language',CHtml::listData(Languages::model()->findAll(),'language_id','language_name'),array('prompt'=> 'Please Select','style'=>"box-sizing: border-box;
width: 100%;
margin-bottom: 15px;
padding: 3%;
border: 1px solid rgb(213, 213, 213);
...
border-image-repeat: initial;")); ?>
			...
			<?php if(isset( Yii::app()->session['social']) && count( Yii::app()->session['social']) && $_REQUEST['type'] == 'social'){ ?>		
					...
					<div class="register-password">
						...
						<?php echo $form->passwordField($normalregister,'password', array('onfocus'=>"theFocus('1')",'onblur'=>"theBlur('1');")); ?>
						<?php echo $form->error($normalregister,'password'); ?>
						<p class="hint"  id="tooltip_1" style="display:none;">Note: Password must be 6 to 16 characters long and contain all of the following: upper case letters, lower case letters, digits and special characters.</p>
				  </div>
...
<h3 class="section-title" style="margin:0px 0px 20px 0px;">New Iyer Registration</h3>			
<div class="not-logged">
			...
			<div id="ait-dir-register-tab">
				...
				<?php $form=$this->beginWidget('CActiveForm', array(
					...
					<div class="register-gender">
						...
						<?php echo $form->dropDownList($register,'gender',array('Mr'=>'Mr.','Ms'=>'Ms.','Mrs'=>'Mrs.'),array('prompt'=> 'Please Select','style'=>"box-sizing: border-box;
width: 100%;
margin-bottom: 15px;
padding: 3%;
border: 1px solid rgb(213, 213, 213);
...
border-image-repeat: initial;")); ?>
					...
					<div class="register-language">
							...
							<?php echo $form->dropDownList($register,'language',CHtml::listData(Languages::model()->findAll(),'language_id','language_name'),array('prompt'=> 'Please Select','style'=>"box-sizing: border-box;
width: 100%;
margin-bottom: 15px;
padding: 3%;
border: 1px solid rgb(213, 213, 213);
...
border-image-repeat: initial;")); ?>
					...
					<div class="register-password">
						<?php echo $form->labelEx($normalregister,'password'); ?>
						<?php echo $form->passwordField($normalregister,'password', array('onfocus'=>"theFocus('2')",'onblur'=>"theBlur('2');")); ?>
						<?php echo $form->error($normalregister,'password'); ?>
						<p class="hint"  id="tooltip_2" style="display:none;">Note: Password must be 6 to 16 characters long and contain all of the following: upper case letters, lower case letters, digits and special characters.</p>
				  </div>
...
<!---------user-------->
	...
	<h3 class="section-title" style="margin:0px 0px 20px 0px;">New Guide Registration</h3>			
<div class="not-logged">
			<div id="ait-login-tabs">
...
border-image-repeat: initial;")); ?>
					...
					<div class="register-password">
						<?php echo $form->labelEx($normalregister,'password'); ?>
						<?php echo $form->passwordField($normalregister,'password', array('onfocus'=>"theFocus('3')",'onblur'=>"theBlur('3');")); ?>
						<?php echo $form->error($normalregister,'password'); ?>
						<p class="hint"  id="tooltip_3" style="display:none;">Note: Password must be 6 to 16 characters long and contain all of the following: upper case letters, lower case letters, digits and special characters.</p>
				  </div>
...
.widget_directory form label, #dir-login-form-popup form label {
	...
	document.getElementById('tooltip_'+value).style.display = 'block';
	}
	function theBlur(value)
	{
	  document.getElementById('tooltip_'+value).style.display = 'none';
	}
	</script>
