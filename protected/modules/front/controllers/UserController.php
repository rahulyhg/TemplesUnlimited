...

{
...

	{
		...
		return array(
			...
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'actions'=>array('index','view','dynamiccities','guideimageupload','uploadvideo','uploadguidelicense','uploadiyerimage','dynamiccitiesiyer','create','update','option_form','getsubcategories','guideactivities','guideactivitypersonform', 'guideactivitygroupform', 'guideactivityform','guidedetails','Regsuccess','iyerdetails','verifiedemail','socialregsuccess'),
			...
			if (Yii::app()->request->isAjaxRequest){ 
...

							{
							    ...
							    $iyer->user_id = $model->user_id;
							   	...
							   	$iyer->availability_dates = date('Y-m-d');
	...
	function actionSocialregsuccess($id){
				...
				$message = 'Welcome to TemplesUnlimited,'.$userdetails->first_name.' '.$userdetails->last_name.'!<br><br>To complete your registration, please confirm your email address by clicking the link below or copying and pasting it into your browse: <a target="_blank" href="'.Yii::app()->params['SITE_BASE_URL'].'/front/user/verifiedemail/id/'.$id.'">'.Yii::app()->params['SITE_BASE_URL'].'front/user/verifiedemail/id/'.$id.'</a>.<br><br> Once your account is confirmed, type your username, password and hit "login". Thats it!.<br><br>If you find any difficulties or having queries, contact us at http://livedemo.blazewebtech.com/temples_new/contact/.<br><br><br>Best Regards<br><span class="il">The TemplesUnlimited Team.</span>';
			...
			Yii::app()->session['social'] = array();
			   ...
			   if( $userdetails->role == '2'){
	              ...
	              Yii::app()->user->setFlash("success", "<table>
											...
											You can login using ".$userdetails->social_provider." Account
...
//mail("$to","$subject",$message);
...

	{
		 ...
		 Yii::app()->user->setFlash("email_verified", $name);
