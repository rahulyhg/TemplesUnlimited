">
<?php if((int)$g>1){ ?>
<input type="buttton" value="Remove" class="btn btn-danger span2 btn-small pull-right" onclick="remove_div('activitiesgroupform<?php echo $key; ?><?php echo $g; ?>')" />
<?php } ?>
				 <h5>Group <?php echo $g; ?></h5>	
				   <?php  $k = '1';   ?>			
				  <div class="activitiesgroupmemberforms"  id="<?php echo $key; ?><?php echo $g; ?><?php echo $k; ?>">
				  <input type="button" class="btn btn-success span2 pull-right get_Guide_group_member_form<?php echo $key; ?><?php echo $g; ?><?php echo $k; ?>" value="Add more member" data-name="<?php echo 'Guideactivities['.$key.'][activity_plans][type]['.$g.'][member]'; ?>" />	
