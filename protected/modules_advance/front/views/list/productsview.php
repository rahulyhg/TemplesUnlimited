...
<div class="sc-column one-half">
						<select  style="padding:2%; width:30%;font-family:'ralewayregular' !important;" name="categories" id="categories" class="filteritem123"  onchange="changecategoris(this.value);">
						<?php echo $options; ?>
						</select>


						<input type="text" style="padding:2%; width:35%;margin-left:10px;" placeholder="Search Keyword..." name="title" id="title" class="filteritem" value="<?php echo isset($_REQUEST['title'])?$_REQUEST['title']:''; ?>">
