...
<a style="background-color: #CB202D; border-radius:10px; width:100%; margin-left:5%;" class="sc-button aligncenter left store-cart" href="<?php echo CHtml::normalizeUrl(array("detail/storeold/id/".helpers::simple_encrypt($data->product_id))); ?>"><span class="border"><span class="wrap"><span style="color: #ffffff;" class="title">View Details</span></span></span></a>&nbsp;
<?php } ?>
