...
<?php if($model->role == '2'){
				...
				{
				 $pooja = Pooja::model()->getinfo($poojas[$i]);
...
<!--<tr height="40px" class="">
<th width="2%" align="left" class="profile-odd-content" ><strong>Poojas</strong><span class="right">:</span></th>
...
<div class="editfields">
      <?php 
	   echo $form->dropDownList($detailsmodel, 'iyer_categories',CHtml::listData(Pooja::model()->getall(),'pooja_id','pooja_name'), array('prompt'=> 'Please Select', 'multiple' => 'multiple')); ?>
<span class="errormsg"></span>
</div>
<div style="clear:both;">&nbsp;</div>
