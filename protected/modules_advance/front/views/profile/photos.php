...
$form=$this->beginWidget('CActiveForm', array(
	...
	'htmlOptions'=>array('class'=>'wpcf7-form', 'enctype' => 'multipart/form-data',),
		    ...
		    <div class="left">
				 <?php echo $form->labelEx($imagemodel,'image_path',array('class'=>'alignleft password-label')); ?>
...
<br>
			...
			<div class="wpcf7 alignright">
				<?php echo CHtml::SubmitButton('Upload',array("id"=>"wp-submit","class" => "sc-button alignright light profile-font",'style'=>'background-color: #CB202D; color: #fff; width: 150px; font-style:bold; font-size:13px; margin-left:5px; border-radius:3px') ); ?>
				</div>
			</div>
