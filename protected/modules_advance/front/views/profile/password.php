...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'htmlOptions' => array(
      ...
      <p class="note"><span class="required">*</span> All Fields are required.</p>
	...
	<?php } ?>
        ...
        <div class="left">
		  <?php echo $form->labelEx($model,'currentpassword',array('class'=>'alignleft password-label')); ?> 
			...
			<?php echo $form->textField($model,'currentpassword',array('size'=>450,'maxlength'=>450,'class'=>'')); ?>
	   ...
	   <div class="left">
		  <?php echo $form->labelEx($model,'newpassword',array('class'=>'alignleft password-label')); ?>
            <div class="wpcf7 alignright">				
			<?php echo $form->textField($model,'newpassword',array('size'=>450,'maxlength'=>450,'class'=>'')); ?>
	   ...
	   <div class="left">
		  <?php echo $form->labelEx($model,'connewpassword',array('class'=>'alignleft password-label')); ?>
            <div class="wpcf7 alignright">				
			<?php echo $form->textField($model,'connewpassword',array('size'=>450,'maxlength'=>450,'class'=>'')); ?>
