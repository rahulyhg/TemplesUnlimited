...
<li class="item clearfix administrator" id="right-border">
			<div class="item-content-wrapper clearfix left">
				...
				<div class="item-description left">
					<h3 class="item-title "><a href="<?php echo CHtml::normalizeUrl(array("detail/guide/id/".helpers::simple_encrypt($data->user_id))); ?>"><?php echo $data->guidemoredetails->guide_title; ?></a>
				...
				<div class="left">
					<a href="<?php echo CHtml::normalizeUrl(array("detail/guide/id/".helpers::simple_encrypt($data->user_id))); ?>" style="margin-right: 19px;" class="left"><?php echo helpers::view_image( $guideimage,array('height'=>'150px','width'=>'150px')); ?></a>
				</div>
