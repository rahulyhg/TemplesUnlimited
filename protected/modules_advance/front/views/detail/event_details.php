...
$simple_date =  $month." ".$event_date[2].",".$event_date[0];
else
...
<a style="background-color: #BFBFBF; color: #fff; font-size:13px; margin-left:5px; border-radius:3px;" class="sc-button light right" href="<?php echo CHtml::normalizeUrl(array("list/newsevents#tab-641-2")); ?>">Back</a>
</div>
