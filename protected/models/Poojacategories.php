 ...
 */
class Poojacategories extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
		'poojas' => array(self::HAS_MANY, 'Pooja', 'pooja_category_id'),
		);
	}
	...
	public function getall_byids($ids){
             return $this->findAllByAttributes(array('category_id'=>$ids));
	}
}
