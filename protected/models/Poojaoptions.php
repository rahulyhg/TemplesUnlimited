 ...
 */
class Poojaoptions extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('pooja_id, 	option_desc, option_price', 'required'),
			array('option_desc', 'length', 'max'=>480),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pooja_option_id,  	pooja_id, 	option_desc, option_price, option_shipping_price', 'safe'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'poojadetails' => array(self::BELONGS_TO, 'Pooja', 'pooja_id'),
	...
	public function attributeLabels()
	{
		return array(
			'pooja_option_id' => 'ID',
			'pooja_id' => 'pooja_id',
			'option_desc' => 'Option Title',
			'option_price' => 'Option Price',
			'option_shipping_price' => 'Option Shipping Price',
		);
	}
