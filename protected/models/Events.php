...
class Events extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('event_name, event_content, event_start_date, event_end_date, event_start_time, event_end_time, phone_no,event_address', 'required'),
			array('event_name, event_address', 'length', 'max'=>500),
			array('event_start_time,event_end_time, phone_no, email_id', 'length', 'max'=>250),
			array('event_image', 'file', 'types'=>'jpg, gif, png,jpeg','on'=>'create'),
			array('event_image', 'file','allowEmpty'=>true, 'types'=>'jpg, gif, png,jpeg','on'=>'update'),
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
						'sort' => array(
        'defaultOrder' => 'event_start_date ASC', 
    ),
